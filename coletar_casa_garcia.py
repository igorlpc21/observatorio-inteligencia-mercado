...
def main():
    ...
    for pagina in range(
        ...
        if resposta.status_code != 200:
            print(
                "Coleta interrompida por "
                "resposta diferente de 200."
            )
            break
    ...
    arquivo_saida = (
        pasta_saida
        / "produtos_casa_garcia_teste.csv"
    )
